    ...
    <div>
      <div className="container mx-auto w-full py-10 tems-stretch">
        <div className="w-full py-4">
          <div className="p-4"> <h1 className="py-4"> {str("Create event")} </h1> </div>
          <p> {str("Create events for your club or by yourself. Items marked with asterisk must be filled.")} </p>
        </div>
          ...
          <div className="sm:w-1/2 w-full mb-4">
            <div className="sm:p-3">
              ...
              <input
                type_="text"
                name="name"
                className="flex flex-wrap w-full  leading-normal w-px border h-10 border-grey-light rounded px-3 relative focus:border-blue focus:shadow"
