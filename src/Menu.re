        ...
        <ul className="list-reset flex flex-row md:flex-col text-center md:text-left">
          <li className="mr-3 flex-1">
            <a
              href="#"
              className={
                self.state.clickedMenu == "Home"
                  ? "block py-1 md:py-3 pl-1 align-middle text-white no-underline border-b-2 border-orange-dark"
                  : "block py-1 md:py-3 pl-1 align-middle text-grey-darkest no-underline hover:text-orange border-b-2 border-grey-darkest md:border-black hover:border-orange"
              }
              onClick={_e => {
                ReasonReact.Router.push("/home");
                self.send(Clicked("Home"));
              }}>
          ...
          <li className="mr-3 flex-1">
            <a
              href="#"
              className={
                self.state.clickedMenu == "YourEvents"
                  ? "block py-1 md:py-3 pl-1 align-middle text-white no-underline border-b-2 border-orange-dark"
                  : "block py-1 md:py-3 pl-1 align-middle text-grey-darkest no-underline hover:text-orange border-b-2 border-grey-darkest md:border-black hover:border-orange"
              }
              onClick={_e => {
                ReasonReact.Router.push("/your-events");
                self.send(Clicked("YourEvents"));
              }}>
          ...
          <li className="mr-3 flex-1">
            <a
              href="#"
              className={
                self.state.clickedMenu == "Map"
                  ? "block py-1 md:py-3 pl-1 align-middle text-white no-underline border-b-2 border-orange-dark"
                  : "block py-1 md:py-3 pl-1 align-middle text-grey-darkest no-underline hover:text-orange border-b-2 border-grey-darkest md:border-black hover:border-orange"
              }
              onClick={_e => {
                ReasonReact.Router.push("/map");
                self.send(Clicked("Map"));
              }}>
          ...
          <li className="mr-3 flex-1">
            <a
              href="#"
              className={
                self.state.clickedMenu == "Profile"
                  ? "block py-1 md:py-3 pl-1 align-middle text-white no-underline border-b-2 border-orange-dark"
                  : "block py-1 md:py-3 pl-1 align-middle text-grey-darkest no-underline hover:text-orange border-b-2 border-grey-darkest md:border-black hover:border-orange"
              }
              onClick={_e => {
                ReasonReact.Router.push("/profile");
                self.send(Clicked("Profile"));
              }}>
